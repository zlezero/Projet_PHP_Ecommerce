...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 20 juin 2020 à 15:15
...
(8, 'Jerry', 'Jerry la souris est un personnage fictif appartenant à la série d\'animation américaine Tom et Jerry, et l\'un des deux principaux protagonistes de la série, le deuxième étant Tom le chat.', 'https://pngimg.com/uploads/tom_and_jerry/tom_and_jerry_PNG56.png', 3, 2, 1),
(9, 'Tom', 'Tom le chat est un personnage fictif appartenant à la série d\'animation américaine Tom et Jerry, et l\'un des deux principaux protagonistes de la série, le deuxième étant Jerry.', 'https://monguideduchat.files.wordpress.com/2015/05/tomcatheader.png', 5, 9, 1),
...
(16, 'Dingo', 'Dingo est un personnage de fiction de l\'univers de Mickey Mouse créé par la Walt Disney Company en 1932. Ce chien anthropomorphe est l\'un des meilleurs amis de Mickey. ', 'https://anotherwhiskyformisterbukowski.com/wp-content/uploads/2018/04/Disney-4.gif', 10, 0, 1),
...
(21, 'Alvin', 'Alvin et les Chipmunks est un groupe de musique fictif, créé aux États-Unis en 1958. Il est composé de trois tamias, Alvin, Simon et Théodore, aidés de leur père adoptif Dave Seville.', 'https://whyevolutionistrue.files.wordpress.com/2014/02/alvin1.jpg', 8, 2, 1),
...
(23, 'Daffy Duck', 'Daffy Duck est un personnage d\'animation américain appartenant à la grande famille de Warner Bros.', 'https://vignette.wikia.nocookie.net/heroes-and-villians/images/2/2a/20180909_151332.jpg/revision/latest?cb=20180909193618', 2, 2, 1),
