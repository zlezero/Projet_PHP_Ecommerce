...
class ArticlesManager{
    ...
    public function getAllArticlesAvecPagination(){
        try {
            ...
            $this->prevlink = ($this->page > 1) ? '<a class="page-link" href="?page=1" title="Première page">&laquo;</a></li> <li class="page-item"><a class="page-link" href="?page=' . ($this->page - 1) . '" title="Page précédente">&lsaquo;</a>' : '<a class="page-link" href="#" aria-label="Précédent"><span class="disabled">&laquo;</span></a></li> <li class="page-item"><a class="page-link" href="#" aria-label="First Page"><span class="disabled">&lsaquo;</span></a>';
            $this->nextlink = ($this->page < $this->pages) ? '<a class="page-link" href="?page=' . ($this->page + 1) . '" title="Page suivante">&rsaquo;</a></li> <li class="page-item"><a class="page-link" href="?page=' . $this->pages . '" title="Dernière page">&raquo;</a>' : '<a class="page-link" href="#" aria-label="Next"><span class="disabled">&rsaquo;</span></a></li> <li class="page-item"><a class="page-link" href="#" aria-label="Last Page"><span class="disabled">&raquo;</span></a>';
